...
class MoGeModelV2(nn.Module):
    ...
    def __init__(self, 
        ...
        **deprecated_kwargs
        ...
        super(MoGeModelV2, self).__init__()
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, Path, IO[bytes]], model_kwargs: Optional[Dict[str, Any]] = None, **hf_kwargs) -> 'MoGeModelV2':
        """

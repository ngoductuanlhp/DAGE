...
def chain_relative_pose(relative_pose_1, relative_pose_2):
    trans_1 = relative_pose_1[..., :3]
    quat_1 = relative_pose_1[..., 3:]
    trans_2 = relative_pose_2[..., :3]
    quat_2 = relative_pose_2[..., 3:]

    rot_1 = quaternion_to_matrix(quat_1)

    trans_3 = trans_1 + einsum(rot_1, trans_2, "... i j, ... j -> ... i")
    # trans_3 = trans_1 + rot_1 @ trans_2
    quat_3 = quaternion_multiply(quat_1, quat_2)

    return torch.cat([trans_3, quat_3], dim=-1)